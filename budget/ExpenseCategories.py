...
def main():
    ...
    s = '''\
        ...
        expenses.read_expenses('data/spending_data.csv')'''
    print(str(s))
    print(timeit.timeit(stmt = 'expenses.categorize_for_loop()',setup=s,number=100000,globals=globals()))
    print(timeit.timeit(stmt = 'expenses.categorize_set_comprehension()',setup=s,number=100000,globals=globals()))
    fig,ax=plt.subplots()
